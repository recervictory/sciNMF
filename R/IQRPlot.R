#' IQRPlot: Boxplots with IQR and Median Filter
#'
...
#'
#' @param WH.list A nested list containing NMF results for each individual, generated by the \code{\link{RunNMF}} function.
